...
> **Mod necesario:** Esta aplicación complementaria no funciona por sí sola. Primero descarga e instala [Helldivers International desde Nexus Mods](https://www.nexusmods.com/helldivers2/mods/14183). Usa el archivo principal para los nueve idiomas del juego y el archivo **Fandubs** de esa página para las voces rusa o coreana. Selecciona la carpeta del mod instalado; si no usas Arsenal, extrae primero el archivo descargado. El Randomizer no incluye el mod ni su audio.

Asigna al azar tipo de voz e idioma a los cuatro espacios de voz de Helldiver y escribe archivos patch en la carpeta de datos de Helldivers 2. Admite los nueve idiomas del juego y, si están incluidos en el mod seleccionado, los fandubs ruso y coreano.

## 🚀 Instalar y usar

1. Descarga **HelldiversInternational-Randomizer.exe** con el botón de arriba.
2. Ábrelo y selecciona la carpeta del mod (contiene **manifest.json**).
3. Selecciona la carpeta **data** de Helldivers 2 (contiene **bundles.nxa**).
4. Configura las opciones y pulsa **Randomize**.

Si vuelves a desplegar o actualizar el mod principal desde Arsenal, ejecuta otra vez el Randomizer.

## 🛡️ Código y compilación

El ejecutable se construye desde el código Python de este repositorio mediante GitHub Actions. El smoke test de Windows pasó. No incluye audio del juego: al ejecutarlo, lee el mod instalado y escribe los archivos patch.

GitHub Actions usa Python 3.12 y PyInstaller. Obtiene el parser de audio del commit fijado **c408a44**. No empaqueta archivos del juego.
