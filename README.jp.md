...
> **必須MOD:** このアプリ単体では動作しません。まず [Nexus Mods から Helldivers International](https://www.nexusmods.com/helldivers2/mods/14183) をダウンロードしてインストールしてください。ゲーム内9言語にはメインファイルを、ロシア語・韓国語音声には同ページの **Fandubs** ファイルを使用します。インストール済みMODのフォルダーを選択してください。Arsenalを使わない場合は、先にダウンロードしたアーカイブを展開します。RandomizerにMOD本体や音声は含まれません。
