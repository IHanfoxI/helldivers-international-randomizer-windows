...
> **Нужен основной мод:** это приложение не работает отдельно. Сначала скачайте и установите [Helldivers International с Nexus Mods](https://www.nexusmods.com/helldivers2/mods/14183). Для девяти игровых языков используйте основной файл, а для русской или корейской озвучки — файл **Fandubs** на той же странице. Выберите папку установленного мода; если не используете Arsenal, сначала распакуйте архив. Мод и аудио в приложение не входят.
